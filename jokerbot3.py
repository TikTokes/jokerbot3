...
print("logging TRUE ...")
MYtoken = "1682874543:AAGon-yI9ddVP5tMdlPYB4mbC5HmcC4f6eU"
IDadmin = "1242250697"
...
def tellm(update,context):
    ...
    SEARCH ENDED 🔘
            ...
            msgtem = f"""✖️ Not Linked on tellonym 
    ...
    try:
        for user2 in link :
          ...
          try:
            ...
            msdisqus = f"☑️ Linked to disqus "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}\n{msbitb}\n{mspinter}\n{msdisqus}",reply_markup=bar1)

            tellm(update,context)
          except urllib.error.URLError as msg :
            msdisqus = f"✖️ Not Linked to disqus "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}\n{msbitb}\n{mspinter}\n{msdisqus}",reply_markup=bar1)
            tellm(update,context)
    except:
...
def pinter(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            mspinter = f"☑️ Linked to pinterest "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}\n{msbitb}\n{mspinter}",reply_markup=bar1)
            disqus(update,context)
          except urllib.error.URLError as msg :
            mspinter = f"✖️ Not Linked to pinterest "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}\n{msbitb}\n{mspinter}",reply_markup=bar1)
            disqus(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def bitb(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msbitb = f"☑️ Linked to bitbucket "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}\n{msbitb}",reply_markup=bar1)
            pinter(update,context)
          except urllib.error.URLError as msg :
            msbitb = f"✖️ Not Linked to bitbucket "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}\n{msbitb}",reply_markup=bar1)
            pinter(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def slack(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msslack = f"☑️ Linked to slack "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}",reply_markup=bar1)
            bitb(update,context)
          except urllib.error.URLError as msg :
            msslack = f"✖️ Not Linked to slack "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}\n{msslack}",reply_markup=bar1)
            bitb(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def ycomb(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msycomb = f"☑️ Linked to ycombinator "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}",reply_markup=bar1)
            slack(update,context)
          except urllib.error.URLError as msg :
            msycomb = f"✖️ Not Linked to ycombinator "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}\n{msycomb}",reply_markup=bar1)
            slack(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def flickr(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msflickr = f"☑️ Linked to flickr "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}",reply_markup=bar1)
            ycomb(update,context)
          except urllib.error.URLError as msg :
            msflickr = f"✖️ Not Linked to flickr "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}\n{msflickr}",reply_markup=bar1)
            ycomb(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def four(update,context):
    ...
    try:
        for user2 in link:
            ...
            try:
                openurl = urllib.request.urlopen(user3)
                msfour = f"☑️ Linked to foursquare "
                query.edit_message_text(
                    text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}",
                    reply_markup=bar1)
                flickr(update, context)
            except urllib.error.URLError as msg:
                msfour = f"✖️ Not Linked to foursquare "
                query.edit_message_text(
                    text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}\n{msfour}",
                    reply_markup=bar1)
                flickr(update, context)
...
def gitlab(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msgitlab = f"☑️ Linked to gitlab "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}",reply_markup=bar1)
            four(update,context)
          except urllib.error.URLError as msg :
            msgitlab = f"✖️ Not Linked to gitlab "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}\n{msgitlab}",reply_markup=bar1)
            four(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def past(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            mspast = f"☑️ Linked to pastebin "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}",reply_markup=bar1)
            gitlab(update,context)
          except urllib.error.URLError as msg :
            mspast = f"✖️ Not Linked to pastebin "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}\n{mspast}",reply_markup=bar1)
            gitlab(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def wordp(update,context):
    ...
    try:
        for user2 in link:
            ...
            try:
                openurl = urllib.request.urlopen(user3)
                mswordp = f"☑️ Linked to wordpress "
                query.edit_message_text(
                    text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}",
                    reply_markup=bar1)
                past(update, context)
            except urllib.error.URLError as msg:
                mswordp = f"✖️ Not Linked to wordpress "
                query.edit_message_text(
                    text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}\n{mswordp}",
                    reply_markup=bar1)
                past(update, context)
...
def spotify(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msspotify = f"☑️ Linked to spotify "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}",reply_markup=bar1)
            wordp(update, context)
          except urllib.error.URLError as msg :
              msspotify = f"✖️ Not Linked to spotify "
              query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}\n{msgoodr}\n{msspotify}",reply_markup=bar1)
              wordp(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def vimeo(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msvime = f"☑️ Linked to vimeo "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}",reply_markup=bar1)
            goodr(update,context)
          except urllib.error.URLError as msg :
              msvime = f"✖️ Not Linked to vimeo "
              query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}\n{msvime}",reply_markup=bar1)
              goodr(update, context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def sond(update,context):
    ...
    try:
        for user2 in link :
          ...
          try:
            openurl = urllib.request.urlopen(user3)
            msSND = f"☑️ Linked to soundcloud "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}" ,reply_markup=bar1)
            vimeo(update,context)
          except urllib.error.URLError as msg :
              msSND = f"✖ Not Linked to soundcloud "
              query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}\n{msSND}" ,reply_markup=bar1)
              vimeo(update, context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def yout(update,context):
    ...
    try:
        for user2 in link :
          ...
          try :
            openurl = urllib.request.urlopen(user3)
            msYUT = f"☑️ Linked to youtobe "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}",reply_markup=bar1)
            sond(update,context)
          except urllib.error.URLError as msg :
            msYUT = f"✖ Not Linked to youtobe "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}\n{msYUT}",reply_markup=bar1)
            sond(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def face(update,context):
    ...
    try:
        for user2 in link :
          ...
          try :
            openurl = urllib.request.urlopen(user3)
            ms = f"☑️ Linked to Facebook "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}",reply_markup=bar1)
            yout(update, context)
          except urllib.error.URLError as msg :
              ms = f"✖ Not Linked to Facebook "
              query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}\n{ms}", reply_markup=bar1)
              yout(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def gitHB(update,context):
    ...
    try:
        ...
        if go.status_code == 200:
            megth = f'☑️ Linked to github '
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}", reply_markup=bar1)
            face(update, context)
        else:
            megth = f'✖ Not Linked on github'
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}\n{megth}", reply_markup=bar1)
            face(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def TWSH(update,context):
    ...
    try:
        ...
        if go.status_code == 200:
            msTh = f'☑️ Linked on twitch '
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}", reply_markup=bar1)
            gitHB(update,context)
        else:
            msTh = f'✖️ Not Linked on twitch '
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}\n{msTh}", reply_markup=bar1)
            gitHB(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def tiktok(update,context):
    ...
    try:
        ...
        if go1.status_code == 404:
            msgTIK = f"✖️ Not Linked on tiktok "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}", reply_markup=bar1)
            tellm(update,context)
        elif go1.status_code == 200:
            msgTIK = f"☑️ Linked on tiktok "
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}\n{msgTIK}", reply_markup=bar1)
            TWSH(update,context)
        else:
            TWSH(update,context)
...
def SNP(update,context):
    ...
    try:
        ...
        if '"status_code":"TAKEN"' in go:
            msgSN = f'☑️Linked on snapchat '
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}", reply_markup=bar1)
            tiktok(update,context)
        else:
            msgSN = f'✖ Not Linked on snapchat '
            query.edit_message_text(text=f"{msgt}\n{msgTW}\n{msgSN}", reply_markup=bar1)
            tiktok(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def twitr(update,context):
    ...
    try:
        ...
        if 'error' in go.text:
            msgTW = f'Not Linked on twitter '
            query.edit_message_text(text=f"{msgt}\n{msgTW}", reply_markup=bar1)
            SNP(update,context)
        else:
            msgTW = f'☑️ Linked on twitter '
            query.edit_message_text(text=f"{msgt}\n{msgTW}", reply_markup=bar1)
            SNP(update,context)
    except:
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
...
def teleg2(update, context):
    ...
    if blokID in useID:
        ...
        msg = "نعتذر تم حظرك من البوت"
        update.message.bot.send_message(chat_id=update.message.chat_id, text=f"{msg}")
    elif blokID4 in useID:
        msg = "نعتذر تم حظرك من البوت"
        update.message.bot.send_message(chat_id=update.message.chat_id, text=f"{msg}")
    elif (join.status == "kicked") or (join.status == "left"):
        ms = """
...
def Login(update,context  ):
    tarr = update.message.text.partition(' ')[2]
    tar =str(tarr)
    user_id = update.effective_chat.id
    useID = str(user_id)
    join = context.bot.get_chat_member(chat_id="@vv1ck", user_id=update.effective_chat.id)
...
def subdom(update,context  ):
    ...
    Then click here  >>  /start  
        ...
        update.message.reply_text(text=f'{go}', reply_markup=bar2)
        return MAIN
...
def UL1(update,context):
    ...
    Then click here  >>  /start  
        ...
        update.message.bot.send_message(chat_id=update.message.chat_id, text='You must enter the url')
    else:
      try:
...
Then click here  >>  /start  
    ...
    The number of likes: {lik}
              """
                ...
                update.message.reply_text(text=f"Account Information 🔘\n{ms}", reply_markup=bar1)
                return MAIN
            else:
                update.message.reply_text(text="Please enter a valid username !",reply_markup=bar1)
                return MAIN
        except:
            ms ="""
...
Then click here  >>  /start  
                        """
        query.edit_message_text(text=f"{ms}")
    else:
        msg =  f"""
            time : {tim}
